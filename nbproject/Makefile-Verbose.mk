...
${OBJECTDIR}/src/builtin/console.o: src/builtin/console.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builtin/console.o src/builtin/console.c

${OBJECTDIR}/src/builtin/network.o: src/builtin/network.c 
	${MKDIR} -p ${OBJECTDIR}/src/builtin
	${RM} "$@.d"
...
${OBJECTDIR}/src/escript/array_value.o: src/escript/array_value.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/array_value.o src/escript/array_value.c

${OBJECTDIR}/src/escript/body.o: src/escript/body.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/body.o src/escript/body.c

${OBJECTDIR}/src/escript/builder.o: src/escript/builder.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/builder.o src/escript/builder.c

${OBJECTDIR}/src/escript/character.o: src/escript/character.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/character.o src/escript/character.c

${OBJECTDIR}/src/escript/expression.o: src/escript/expression.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/expression.o src/escript/expression.c

${OBJECTDIR}/src/escript/function.o: src/escript/function.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/function.o src/escript/function.c

${OBJECTDIR}/src/escript/hash.o: src/escript/hash.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/hash.o src/escript/hash.c

${OBJECTDIR}/src/escript/invoke.o: src/escript/invoke.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/invoke.o src/escript/invoke.c

${OBJECTDIR}/src/escript/locate.o: src/escript/locate.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/locate.o src/escript/locate.c

${OBJECTDIR}/src/escript/number.o: src/escript/number.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/number.o src/escript/number.c

${OBJECTDIR}/src/escript/number_value.o: src/escript/number_value.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/number_value.o src/escript/number_value.c

${OBJECTDIR}/src/escript/oop.o: src/escript/oop.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/oop.o src/escript/oop.c

${OBJECTDIR}/src/escript/reference.o: src/escript/reference.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/reference.o src/escript/reference.c

${OBJECTDIR}/src/escript/set.o: src/escript/set.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/set.o src/escript/set.c

${OBJECTDIR}/src/escript/set_value.o: src/escript/set_value.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/set_value.o src/escript/set_value.c
...
${OBJECTDIR}/src/escript/string.o: src/escript/string.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/string.o src/escript/string.c

${OBJECTDIR}/src/escript/string_value.o: src/escript/string_value.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/string_value.o src/escript/string_value.c

${OBJECTDIR}/src/main.o: src/main.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.c
...
${OBJECTDIR}/src/builtin/console_nomain.o: ${OBJECTDIR}/src/builtin/console.o src/builtin/console.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builtin/console_nomain.o src/builtin/console.c;\
	else  \
	    ${CP} ${OBJECTDIR}/src/builtin/console.o ${OBJECTDIR}/src/builtin/console_nomain.o;\
	fi

${OBJECTDIR}/src/builtin/network_nomain.o: ${OBJECTDIR}/src/builtin/network.o src/builtin/network.c 
	${MKDIR} -p ${OBJECTDIR}/src/builtin
	@NMOUTPUT=`${NM} ${OBJECTDIR}/src/builtin/network.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
...
${OBJECTDIR}/src/escript/array_value_nomain.o: ${OBJECTDIR}/src/escript/array_value.o src/escript/array_value.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/array_value_nomain.o src/escript/array_value.c;\
	else  \
...
${OBJECTDIR}/src/escript/body_nomain.o: ${OBJECTDIR}/src/escript/body.o src/escript/body.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/body_nomain.o src/escript/body.c;\
	else  \
...
${OBJECTDIR}/src/escript/builder_nomain.o: ${OBJECTDIR}/src/escript/builder.o src/escript/builder.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/builder_nomain.o src/escript/builder.c;\
	else  \
...
${OBJECTDIR}/src/escript/character_nomain.o: ${OBJECTDIR}/src/escript/character.o src/escript/character.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/character_nomain.o src/escript/character.c;\
	else  \
...
${OBJECTDIR}/src/escript/expression_nomain.o: ${OBJECTDIR}/src/escript/expression.o src/escript/expression.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/expression_nomain.o src/escript/expression.c;\
	else  \
...
${OBJECTDIR}/src/escript/function_nomain.o: ${OBJECTDIR}/src/escript/function.o src/escript/function.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/function_nomain.o src/escript/function.c;\
	else  \
...
${OBJECTDIR}/src/escript/hash_nomain.o: ${OBJECTDIR}/src/escript/hash.o src/escript/hash.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/hash_nomain.o src/escript/hash.c;\
	else  \
...
${OBJECTDIR}/src/escript/invoke_nomain.o: ${OBJECTDIR}/src/escript/invoke.o src/escript/invoke.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/invoke_nomain.o src/escript/invoke.c;\
	else  \
...
${OBJECTDIR}/src/escript/locate_nomain.o: ${OBJECTDIR}/src/escript/locate.o src/escript/locate.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/locate_nomain.o src/escript/locate.c;\
	else  \
...
${OBJECTDIR}/src/escript/number_nomain.o: ${OBJECTDIR}/src/escript/number.o src/escript/number.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/number_nomain.o src/escript/number.c;\
	else  \
...
${OBJECTDIR}/src/escript/number_value_nomain.o: ${OBJECTDIR}/src/escript/number_value.o src/escript/number_value.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/number_value_nomain.o src/escript/number_value.c;\
	else  \
...
${OBJECTDIR}/src/escript/oop_nomain.o: ${OBJECTDIR}/src/escript/oop.o src/escript/oop.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/oop_nomain.o src/escript/oop.c;\
	else  \
...
${OBJECTDIR}/src/escript/reference_nomain.o: ${OBJECTDIR}/src/escript/reference.o src/escript/reference.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/reference_nomain.o src/escript/reference.c;\
	else  \
...
${OBJECTDIR}/src/escript/set_nomain.o: ${OBJECTDIR}/src/escript/set.o src/escript/set.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/set_nomain.o src/escript/set.c;\
	else  \
...
${OBJECTDIR}/src/escript/set_value_nomain.o: ${OBJECTDIR}/src/escript/set_value.o src/escript/set_value.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/set_value_nomain.o src/escript/set_value.c;\
	else  \
...
${OBJECTDIR}/src/escript/source_nomain.o: ${OBJECTDIR}/src/escript/source.o src/escript/source.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/source_nomain.o src/escript/source.c;\
	else  \
...
${OBJECTDIR}/src/escript/string_nomain.o: ${OBJECTDIR}/src/escript/string.o src/escript/string.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/string_nomain.o src/escript/string.c;\
	else  \
...
${OBJECTDIR}/src/escript/string_value_nomain.o: ${OBJECTDIR}/src/escript/string_value.o src/escript/string_value.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/string_value_nomain.o src/escript/string_value.c;\
	else  \
...
${OBJECTDIR}/src/main_nomain.o: ${OBJECTDIR}/src/main.o src/main.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main_nomain.o src/main.c;\
	else  \
