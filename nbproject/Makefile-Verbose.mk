...
${OBJECTDIR}/src/escript/operand.o: src/escript/operand.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/operand.o src/escript/operand.c

${OBJECTDIR}/src/escript/operator.o: src/escript/operator.c 
	${MKDIR} -p ${OBJECTDIR}/src/escript
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/operator.o src/escript/operator.c
...
${OBJECTDIR}/src/escript/operand_nomain.o: ${OBJECTDIR}/src/escript/operand.o src/escript/operand.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/operand_nomain.o src/escript/operand.c;\
	else  \
...
${OBJECTDIR}/src/escript/operator_nomain.o: ${OBJECTDIR}/src/escript/operator.o src/escript/operator.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DVERBOSE -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/escript/operator_nomain.o src/escript/operator.c;\
	else  \
