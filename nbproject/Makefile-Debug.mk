...
${OBJECTDIR}/src/builtin/network.o: src/builtin/network.c 
	${MKDIR} -p ${OBJECTDIR}/src/builtin
	${RM} "$@.d"
	$(COMPILE.c) -g -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builtin/network.o src/builtin/network.c

${OBJECTDIR}/src/builtin/string.o: src/builtin/string.c 
	${MKDIR} -p ${OBJECTDIR}/src/builtin
	${RM} "$@.d"
	$(COMPILE.c) -g -Iinclude -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builtin/string.o src/builtin/string.c
...
${OBJECTDIR}/src/builtin/network_nomain.o: ${OBJECTDIR}/src/builtin/network.o src/builtin/network.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builtin/network_nomain.o src/builtin/network.c;\
	else  \
...
${OBJECTDIR}/src/builtin/string_nomain.o: ${OBJECTDIR}/src/builtin/string.o src/builtin/string.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Iinclude -std=c89 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builtin/string_nomain.o src/builtin/string.c;\
	else  \
